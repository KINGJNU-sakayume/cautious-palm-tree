...
export const achievements = [
  ...
  // Tag-based: log 5 outdoor runs
  {
    ...
    tier: 'silver',
    type: 'one-time',
    condition: { type: 'tag_count', tag: '야외', target: 5 },
    rarity: 30.1,
    isHidden: false,
    isEarned: false,
    earnedAt: null,
  ...
  // Tag-based: log a bench press session tagged as a PR
  {
    ...
    tier: 'silver',
    type: 'repeatable',
    condition: { type: 'tag_match', tag: '개인신기록' },
    rarity: 35.0,
    isHidden: false,
    isEarned: true,
    earnedAt: '2026-03-25',
  ...
  },
  {
    ...
    tier: 'silver',
    type: 'one-time',
    condition: { type: 'cumulative', target: 1000, unit: '페이지' },
    rarity: 34.5,
    isHidden: false,
    isEarned: true,
    earnedAt: '2026-01-10',
  ...
  // Modified: was generic cumulative, now requires reading non-fiction books 3 times
  {
    ...
    tier: 'gold',
    type: 'one-time',
    condition: { type: 'tag_count', tag: '논픽션', target: 3 },
    rarity: 6.2,
    isHidden: false,
    isEarned: false,
    earnedAt: null,
  ...
  // Tag-based: log a deep meditation session
  {
    ...
    tier: 'silver',
    type: 'repeatable',
    condition: { type: 'tag_match', tag: '깊은' },
    rarity: 25.0,
    isHidden: false,
    isEarned: true,
    earnedAt: '2026-03-20',
  ...
  // Modified: was generic count-30, now requires 10 reflection-tagged entries
  {
    ...
    tier: 'silver',
    type: 'one-time',
    condition: { type: 'tag_count', tag: '성찰', target: 10 },
    rarity: 24.1,
    isHidden: false,
    isEarned: false,
    earnedAt: null,
  ...
  },
  {
    ...
    tier: 'gold',
    type: 'one-time',
    condition: { type: 'cumulative', target: 50000, unit: '단어' },
    rarity: 4.6,
    isHidden: false,
    isEarned: false,
    earnedAt: null,
